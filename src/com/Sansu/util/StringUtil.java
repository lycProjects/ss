...
public class StringUtil {
	...
	public static String Html2Text(String inputString) {
		...
		System.out.println("Html2Text2:"+htmlStr);
		String textStr = "";
	...
	/*		String regEx_cont1 = "[`~!@#$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]"; // 定义HTML标签的正则表达式
*/			
			String regEx_cont1 = "[`~!@#$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）——+|{}【】]"; // 定义HTML标签的正则表达式
			...
			System.out.println("test3:"+htmlStr);
			textStr = htmlStr;
		} catch (Exception e) {
			System.err.println("Html2Text: e.getMessage() " + e.getMessage());
		}
