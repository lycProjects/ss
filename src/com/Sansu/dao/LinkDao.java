...
public class LinkDao {
	...
	public List<Link> linkList(Connection con,String sql)throws Exception{//查询友情链接
	...
	public int linkAdd(Connection con,Link link)throws Exception{//添加友情链接
	...
	public int linkUpdate(Connection con,Link link)throws Exception{//更新
